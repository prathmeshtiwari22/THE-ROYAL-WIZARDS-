...
import com.example.umeed.databinding.ActivityMapsBinding;
...
googleurl.append("&type="+s);
    ...
    public void onClick(View view)
    {
        ...
        @SuppressLint("WrongViewCast") Button searchButton = findViewById(R.id.searchbutton);
        @SuppressLint("WrongViewCast") Button hospitalsButton = findViewById(R.id.hospitals_nearby);
        @SuppressLint("WrongViewCast") Button firestationsButton = findViewById(R.id.firestations_nearby);
        @SuppressLint("WrongViewCast") Button policeButton = findViewById(R.id.police_nearby);
        @SuppressLint("WrongViewCast") Button myLocationButton = findViewById(R.id.my_location);

        searchButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EditText addressFeld = findViewById(R.id.locationsearch);
                ...
                if (!TextUtils.isEmpty(address)) {
                    ...
                    //Toast.makeText(MainActivity.this, "Please write location", Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        firestationsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mMap.clear();
                ...
                transferdata[1] = url1;
                getNearbyPlaces.execute(transferdata);
                //Toast.makeText(MainActivity.this, "Showing nearby Fire Station", Toast.LENGTH_LONG).show();
            }
        });
        ...
        policeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transferdata[1] = url2;
                getNearbyPlaces.execute(transferdata);
                //Toast.makeText(MainActivity.this, "Showing nearby Police Station", Toast.LENGTH_LONG).show();
            }
        });
